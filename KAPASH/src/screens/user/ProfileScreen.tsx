        ...
        <View style={s.statsRow}>
          {statsLoading ? (
            ...
            <>
              ...
              <StatBox label="Hours Played" value={stats?.totalHours || 0} />
              <View style={s.statDivider} />
              <StatBox label="Referrals" value={stats?.referrals || 0} />
            </>
          )}
        </View>
...
const s = StyleSheet.create({
  ...
  verifiedBadge: {
    ...
    paddingHorizontal: 12, paddingVertical: 4, borderWidth: 1, borderColor: 'rgba(34,197,94,0.3)',
  },
  ...
  statsRow: {
    flexDirection: 'row', backgroundColor: '#1A2535', marginHorizontal: 16,
  ...
  walletCard: {
    backgroundColor: '#1A2535', borderRadius: 16, marginHorizontal: 16,
    marginBottom: 16, padding: 16, flexDirection: 'row', justifyContent: 'space-between',
  },
  walletLabel: { color: '#9CA3AF', fontSize: 14 },
  walletAmount: { color: '#22C55E', fontWeight: '700', fontSize: 16 },

  menuCard: { backgroundColor: '#1A2535', borderRadius: 16, marginHorizontal: 16, marginBottom: 16, overflow: 'hidden' },
  ...
  logoutBtn: {
    marginHorizontal: 16, backgroundColor: 'rgba(239,68,68,0.1)', borderRadius: 12,
    paddingVertical: 14, alignItems: 'center', borderWidth: 1, borderColor: 'rgba(239,68,68,0.2)',
  },
